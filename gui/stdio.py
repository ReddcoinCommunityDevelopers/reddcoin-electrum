...
_ = lambda x:x
#from i18n import _
from reddcoin_electrum.wallet import WalletStorage, Wallet
from reddcoin_electrum.util import format_satoshis, set_verbosity
from reddcoin_electrum.bitcoin import is_valid
from reddcoin_electrum.network import filter_protocol
...
class ElectrumGui:
    ...
    def do_send(self):
        if not is_valid(self.str_recipient):
            print(_('Invalid Reddcoin address'))
            return
        try:
