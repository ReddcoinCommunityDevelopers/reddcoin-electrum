...
class ElectrumWindow(QMainWindow):
    ...
    def init_menubar(self):
        ...
        help_menu.addAction(_("&Official website"), lambda: webbrowser.open("https://wallet.reddcoin.com"))
        help_menu.addSeparator()
        help_menu.addAction(_("&Documentation"), lambda: webbrowser.open("https://wallet.reddcoin.com/documentation.html")).setShortcut(QKeySequence.HelpContents)
